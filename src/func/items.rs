...
/// Toggle the equipment status on a given object
    ...
    for _ in 0..num_items {
        ...
        if !is_blocked(x, y, map, objects) {
            ...
            let item_chances = &mut [
                ...
                Weighted {
                    weight: from_dungeon_level(&[Transition { level: 1, value: 5 }], level),
                    item: Item::Dagger,
                },
                Weighted {
                    weight: from_dungeon_level(
            ...
            let item = match item_choice.ind_sample(&mut rand::thread_rng()) {
                ...
                Item::LeatherHat => {
                    let mut object = Object::new(x, y, 'H', "leather hat", colors::BRASS, false);
                ...
                Item::LeatherWristGaurds => {
                    let mut object =
                        Object::new(x, y, 'G', "leather gauntlets", colors::BRASS, false);
